...
public class MapGenerator : MonoBehaviour {
    ...
    void ProcessMap()
    {
        ...
        // {
        //     Debug.Log("Room size: " + room.roomSize);
        // }
    ...
    void ConnectClosestRooms(List<Room> allRooms, bool forceAccessibilityFromMainRoom = false)
    {
        ...
        {
            // This is key to making sure that the main room is always connected to the rest of the rooms
            // Consider all rooms to find the best one to connect to
            if (!forceAccessibilityFromMainRoom)
            {
